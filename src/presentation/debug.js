  ...
  update(state, fps) {
    ...
    this.text.textContent = [
      ...
      ...state.events.slice(-5).map(event => {
        ...
        Object.assign(names, { PollPublished: 'Sondage publié', MeetingStarted: 'Meeting lancé', MeetingValidated: 'Meeting terminé', MeetingCancelled: 'Meeting annulé', CommunicationBroadcast: 'Communication diffusée', NpcNeutralized: 'Sympathisant redevenu neutre', DebugInfluenceAdded: 'PNJ convaincu pour le test', DebugBuildingConstructed: 'Construction de test' });
